...
class TestModelFor(unittest.TestCase):
    ...
    def test_anthropic_defaults(self):
        _set_env(LLM_PROVIDER="anthropic", ANTHROPIC_API_KEY="sk-ant-x", OPENAI_API_KEY="")
        _reload()
    ...
    def test_per_tier_env_overrides(self):
        _set_env(LLM_PROVIDER="openai", OPENAI_API_KEY="sk-oai-x",
                 ANTHROPIC_API_KEY="", MODEL_LOW="gpt-4o-mini", MODEL_HIGH="o3", MODEL_MID="")
        _reload()
        from core.llm import model_for
